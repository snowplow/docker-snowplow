...
docker run \
  ...
  snowplow/stream-enrich:0.11.0 \ # if you have built the image
  # snowplow-docker-registry.bintray.io/snowplow/stream-enrich:0.11.0 if you have pulled the image
  --config /snowplow/config/config.hocon \
